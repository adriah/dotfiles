...
static const char colors[NUMCOLORS][ColLast][9] = {
  ...
  { "#373b41", "#c5c8c6", "#1d1f21" }, // 2 = selected (white on black)
  ...
  { "#1d1f21", "#b5bd68", "#1d1f21" }, // 7 = green on black
  { "#282a2e", "#de935f", "#1d1f21" }, // 8 = orange on black
  { "#282a2e", "#f0c674", "#282a2e" }, // 9 = yellow on darkgrey
  { "#282a2e", "#81a2be", "#1d1f21" }, // A = blue on darkgrey
  { "#1d1f21", "#b294bb", "#1d1f21" }, // B = magenta on darkgrey
  { "#282a2e", "#8abeb7", "#1d1f21" }, // C = cyan on darkgrey
  { "#1d1f31", "#c5c8c6", "#282a2e" }, // D = white on darkgrey
};
